document.addEventListener("DOMContentLoaded", function() {
    ...
    const amountField = document.querySelector('#id_digiamount');
    ...
    amountField.addEventListener('input', function() {
        ...
        if (!isNaN(amount)) {
            ...
            amountToWordsField.textContent = '';
        }
    });
    ...
    function convertNumberToWords(num) {
        ...
        if (num === 0) return '<span class="amount-text">صفر</span> <span class="toman">تومان</span>';
